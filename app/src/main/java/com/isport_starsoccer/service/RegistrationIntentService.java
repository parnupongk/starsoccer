...
public class RegistrationIntentService extends IntentService implements ReceiveDataListener {
    ...
    private void sendRegistrationToServer(String token) {
        String url = DataURL.SubmitToken;
        url += "&key="+ token;
    ...
    public void onReceiveDataStream(String loadName, String url, String strOutput) {
        try
        {
            if( strOutput != null )
            {
                ...
                {
                    if(bb.getString("status").equals("Success"))
                    {
                        Toast.makeText(this, bb.getString("status"), Toast.LENGTH_SHORT).show();
                    }
