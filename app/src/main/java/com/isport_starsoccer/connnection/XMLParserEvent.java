...
public class XMLParserEvent extends DefaultHandler
{
	private String img1 = "";
	private String img2 = "";
	private String img3 = "";
	...
	public Vector<DataElementEvent> vData = null;
	...
	public void startElement(String namespaceURI, String localName,String qName, Attributes atts) throws SAXException 
	{
		if (localName.equals("SportApp")) {
			vData = new Vector<DataElementEvent>();
	...
	{
		vData.add(new DataElementEvent(img1, img2, img3, description, phone, url));
