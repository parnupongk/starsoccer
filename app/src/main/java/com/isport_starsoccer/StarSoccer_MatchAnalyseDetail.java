...
public class StarSoccer_MatchAnalyseDetail extends Activity implements  OnClickListener
{
	...
	private DataElementGroupMatchAnalyse data = null;
...
//		progress = ProgressDialog.show(this, null, "Loading...", true, true);
        ...
        if(getIntent().getExtras() != null)
        {
        	...
        	data = (DataElementGroupMatchAnalyse) b.get("data");
